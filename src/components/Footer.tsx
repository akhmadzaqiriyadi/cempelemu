      ...
      <div className="bg-[#FFD700] py-10 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            ...
            id="footer-wa-cta"
            className="inline-flex items-center gap-3 bg-[#1F2937] text-white font-bold px-8 py-3.5 rounded-full hover:bg-[#E30613] transition-colors duration-200 shadow-lg text-sm sm:text-base"
          >
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-1 mb-4">
              <span className="text-2xl font-extrabold text-[#E30613]">Cempe</span>
              <span className="text-2xl font-extrabold text-[#FFD700]">Lemu</span>
            </div>
            <p className="text-white/60 text-sm leading-relaxed max-w-xs">
              Spesialis Sate Kambing Muda Khas Tegal. Lembut, juicy, dan otentik. 
              Tersedia di 3 cabang strategis di Tegal Raya.
            </p>
            {/* Social */}
            <div className="flex items-center gap-3 mt-6">
              {[
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={s.label}
                  className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#FFD700] transition-colors duration-200"
                >
